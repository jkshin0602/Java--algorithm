...
public class 외벽_점검 {
	...
	//레스토랑의 구조는 동그란 모양, 외벽의 총 둘레는 n미터
	//레스토랑의 정북 방향 지점 0, 취약 지점 위치는 정북 방향으로 부터 시계 방향으로 떨어진 거리
	//출발 지점부터, 시계, 반시계 방향으로 외벽을 따라서 이동
	//투입해야하는 친구의 최솟값

	public static int solution(int n, int[] weak, int[] dist) {
		//길이를 2배로 늘려서 '원형'을 일자 형태로 변경
		ArrayList<Integer> weakList = setWeak(n, weak);
	...
	//길이를 2배로 늘려서 '원형'을 일자 형태로 변경
	private static ArrayList<Integer> setWeak(int n, int[] weak) {
